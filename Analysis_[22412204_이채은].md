...
| :--- | :--- | :--- | :--- |
| 2026.04.27 | 1.00 | First Draft | 이채은 |
...
&middot; 공유 구독 시 인원별 정산 금액을 자동으로 산출하여 정산 관리의 편의정을 제공해야한다.
...
&middot; 용자가 직접 입력하는 과정에서 발생할 수 있는 데이터 오류를 방지하고 정합성을 유지해야 한다.
...
![Use  Case Diagram](22412204이채은_UseCaseDiagram.png)
제안된 시스템은 개인 사용자, 관지라, 시스템을 대상으로 하기 때문에 Actor은 Customer, Manager, System 3명이다.
&middot; Login
...
#### 4.2. Sign-Up Screen (User Onboarding)

![Sign-up](SignUp.png)[그림4-2] Sign-up Screen  
...
6.1. 소프트웨어 공학 강의 교안 및 분석 설계 예시 (Example 6, MNY)

6.2. Java Swing GUI 및 JDBC 데이터베이스 프로그래밍 가이드

6.3. 프로젝트 관련 기술 문서 (Use Case 및 UI Prototype 설계서)
